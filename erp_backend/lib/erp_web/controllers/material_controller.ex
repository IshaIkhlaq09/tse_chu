...
"""
  use ErpWeb, :controller //The code defines a controller module ErpWeb.MaterialController responsible for managing materials. 
...
The show_all_materials/2 function retrieves all materials and renders them in JSON format.
  @doc """
  Show all materials.
  """
